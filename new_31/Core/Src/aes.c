...
static xdata unsigned char glb_round_key_table[4 * NB * (NR + 1)];
...
static code const unsigned char inv_sbox[256] =
{
...
#define add_round_key(pt_state, pt_round_key) \
xor_bytes((pt_state), (pt_round_key), 4 * NB)
