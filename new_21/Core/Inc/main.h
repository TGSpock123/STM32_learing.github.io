...
#define pwm_led_1_Pin GPIO_PIN_1
#define pwm_led_1_GPIO_Port GPIOA
#define motor_1_Pin GPIO_PIN_14
#define motor_1_GPIO_Port GPIOB
#define motor_2_Pin GPIO_PIN_15
...
#define encoder_1_b_Pin GPIO_PIN_6
#define encoder_1_b_GPIO_Port GPIOB
#define encoder_1_b_EXTI_IRQn EXTI9_5_IRQn
