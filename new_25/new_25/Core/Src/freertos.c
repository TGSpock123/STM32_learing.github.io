...
/* Definitions for queue_input_to_uart */
osMessageQueueId_t queue_input_to_uartHandle;
const osMessageQueueAttr_t queue_input_to_uart_attributes = {
  .name = "queue_input_to_uart"
};
/* Definitions for queue_uart_to_output */
osMessageQueueId_t queue_uart_to_outputHandle;
const osMessageQueueAttr_t queue_uart_to_output_attributes = {
  .name = "queue_uart_to_output"
};
/* Definitions for queue_output_to_input */
osMessageQueueId_t queue_output_to_inputHandle;
const osMessageQueueAttr_t queue_output_to_input_attributes = {
  .name = "queue_output_to_input"
};
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the queue(s) */
  /* creation of queue_input_to_uart */
  queue_input_to_uartHandle = osMessageQueueNew (10, sizeof(uint32_t), &queue_input_to_uart_attributes);

  /* creation of queue_uart_to_output */
  queue_uart_to_outputHandle = osMessageQueueNew (10, sizeof(uint32_t), &queue_uart_to_output_attributes);

  /* creation of queue_output_to_input */
  queue_output_to_inputHandle = osMessageQueueNew (10, sizeof(uint32_t), &queue_output_to_input_attributes);
...
void start_task_uart(void *argument)
{
  ...
  HAL_UART_Receive_IT(&huart2, (uint8_t *) rx_buffer, 30);
  /* Infinite loop */
  for(;;)
  {
    vTaskDelay(1000);
