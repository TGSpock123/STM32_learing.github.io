...
//LCD的画笔颜色和背景色	   
uint16_t FRONT_COLOR = GREEN;	//画笔颜色
...
//	GPIO_Initure.Pin=GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_14|GPIO_PIN_15;
...
//	TFTLCD_FSMC_Init();
  ...
  vTaskDelay(pdMS_TO_TICKS(40));
	...
	vTaskDelay(pdMS_TO_TICKS(5)); // Dis-charge capacitor power voltage
